...
entry = (*cmes_settings[0]);
text = (%entry.text);
setting = (%entry.setting);
func = cmes_update_hyperspeed;
id = p1_hyperspeed_text;
...
entry = (*cmes_settings[1]);
text = (%entry.text);
setting = (%entry.setting);
func = cmes_update_hyperspeed;
id = p2_hyperspeed_text;
cmes_format_text(text=%text, setting=%setting, func=%func);
...
entry = (*cmes_settings[2]);
text = (%entry.text);
setting = (%entry.setting);
func = cmes_toggle_setting;
id = disable_hit_flames_text;
cmes_format_text(text=%text, setting=%setting, func=%func);

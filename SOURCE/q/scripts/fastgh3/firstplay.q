...
script create_first_launch_menu
	...
	CreateScreenElement \{ text = 'To ensure the perfect gameplay experience for you, we\'ll want to make sure you\'re able to get to playing right away without any issues. Due to the way this game handles currently connected controllers, it may interfere with how you prefer to launch this mod if you connect and disconnect your controllers between sessions. To work around this, would you like to be prompted to press a button on any controller you want to play with upon starting a song or do you wish to assign a default controller to skip the initial prompt? You can return to this menu by setting AutoStart to -1 in the Player section of the settings.ini.' Type = TextBlockElement parent = pab_container font = text_a4 dims = (1330.0, 640.0) Pos = (640.0, 180.0) just = [center top] internal_just = [center top] shadow shadow_offs = (2.0, 2.0) shadow_rgba = [ 0 0 0 127 ] Scale = 0.64 allow_expansion }

...
script winport_create_gfx_settings_menu
	...
	displaySprite \{parent = screen_container tex = graphics_options_poster_part1 Pos = (640.0, 360.0) Scale = (1.600000023841858, 1.7000000476837158) just = [center center] z = 1 rot_angle = 2}

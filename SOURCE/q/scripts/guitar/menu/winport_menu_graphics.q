...
script winport_create_gfx_settings_menu
	...
	CreateScreenElement \{Type = TextElement parent = screen_container text = "GRAPHICS" Pos = (837.0, 180.0) Scale = (1.8, 1.68) just = [center center] rgba = [50 0 0 255] font = #"0x42c721dd" z_priority = 10 rot_angle = 6 Shadow shadow_rgba = [160 130 105 255] shadow_offs = (-3.0, 3.0)}

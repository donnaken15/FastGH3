...
script create_controller_settings_menu\{popup = 0}
	...
	if (<popup>)
		...
		CreateScreenElement \{Type = SpriteElement parent = cs_container id = cs_light_overlay texture = #"0xf6c8349f" Pos = (640.0, 360.0) dims = (1280.0, 720.0) just = [center center] z_priority = 99}
		displaySprite \{parent = cs_container tex = #"0x793539b8" Pos = (135.0, 30.0) dims = (640.0, 620.0) rot_angle = -1.5 z = 5}
		displaySprite \{parent = cs_container tex = #"0x0d145f07" Pos = (525.0, 130.0) dims = (552.0, 266.0)}
		displaySprite \{parent = cs_container tex = #"0x5f0e2ef1" Pos = (610.0, 0.0) dims = (120.0, 60.0) z = 6 rot_angle = 60}
		displaySprite \{parent = cs_container tex = #"0x5f0e2ef1" rgba = [0 0 0 128] Pos = (608.0, 5.0) dims = (120.0, 60.0) z = 6 rot_angle = 60}
		displaySprite \{parent = cs_container tex = #"0xc16abb52" Pos = (760.0, 106.0) dims = (140.0, 65.0) z = 4}
		displaySprite \{parent = cs_container tex = #"0xc16abb52" rgba = [0 0 0 128] Pos = (763.0, 111.0) dims = (140.0, 65.0) z = 4}
		displaySprite \{parent = cs_container tex = #"0x01c66f71" Pos = (250.0, 360.0) dims = (80.0, 142.0) z = 6 flip_v rot_angle = -10}
		displaySprite \{parent = cs_container tex = #"0x01c66f71" rgba = [0 0 0 128] Pos = (255.0, 363.0) dims = (80.0, 142.0) z = 6 flip_v rot_angle = -10}
		displaySprite \{parent = cs_container tex = #"0x28091e67" Pos = (1090.0, 300.0) dims = (112.0, 54.0) z = 4 rot_angle = -80}
		displaySprite \{parent = cs_container tex = #"0x28091e67" rgba = [0 0 0 128] Pos = (1095.0, 305.0) dims = (112.0, 54.0) z = 4 rot_angle = -80}
		CreateScreenElement {
			Type = TextElement
		...
		displaySprite \{parent = cs_container tex = #"0x3f147ec8" Pos = (945.0, 190.0) z = 4 flip_h rot_angle = -5 Scale = 0.7}
		displaySprite \{parent = cs_container id = cs_check_1 tex = #"0xdd70901e" Pos = (975.0, 197.0) z = 6 Scale = 0.7}
		displaySprite \{parent = cs_container tex = #"0x3f147ec8" Pos = (950.0, 236.0) z = 5 rot_angle = -5 Scale = 0.7}
		displaySprite \{parent = cs_container id = cs_check_2 tex = #"0xdd70901e" Pos = (970.0, 230.0) z = 6 Scale = 0.7}
		displaySprite {
			parent = cs_container
			id = cs_highlighter
			tex = #"0x98544e5b"
...
script controller_settings_menu_update_lefty_flip_p1_value\{lefty_flip_p1 = 0}
	if (<lefty_flip_p1>)
		if NOT ($cs_is_popup)
			SetScreenElementProps \{id = cs_check_1 texture = #"0xa986bfc3"}
		...
		if NOT ($cs_is_popup)
			SetScreenElementProps \{id = cs_check_1 texture = #"0xdd70901e"}
...
script controller_settings_menu_update_lefty_flip_p2_value\{lefty_flip_p2 = 0}
	if (<lefty_flip_p2>)
		if NOT ($cs_is_popup)
			SetScreenElementProps \{id = cs_check_2 texture = #"0xa986bfc3"}
		else
			SetScreenElementProps \{id = lefty_flip_p2_se text = "P2 Lefty Flip: ON"}
		endif
	else
		if NOT ($cs_is_popup)
			SetScreenElementProps \{id = cs_check_2 texture = #"0xdd70901e"}
		else

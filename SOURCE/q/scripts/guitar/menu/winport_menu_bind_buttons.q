...
script winport_create_bind_buttons
	...
	CreateScreenElement \{Type = TextElement parent = screen_container text = 'KEYBOARD' Pos = (830.0, 100.0) Scale = (1.51, 1.3) just = [center center] rgba = [202 243 113 255] font = #"0x42c721dd" z_priority = 10 rot_angle = -2.8 Shadow shadow_rgba = [0 0 0 255] shadow_offs = (-3.0, 3.0)}

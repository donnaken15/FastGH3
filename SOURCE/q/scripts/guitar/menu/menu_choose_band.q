choose_band_menu_font = #"0xaba484e8"
...
script create_choose_band_menu
	...
	if (<rand> = 0)
		SetScreenElementProps \{id = random_image texture = #"0xa7453955"}
	elseif (<rand> = 1)
		SetScreenElementProps \{id = random_image texture = #"0x3e4c68ef"}
	elseif (<rand> = 2)
		SetScreenElementProps \{id = random_image texture = #"0x494b5879"}
	endif
	CreateScreenElement \{Type = SpriteElement parent = cb_helper_container id = ticket_overlay texture = #"0x7151e106" rgba = [255 255 255 255] Pos = (734.0, 360.0) dims = (684.0, 680.0) just = [center center] z_priority = 2}

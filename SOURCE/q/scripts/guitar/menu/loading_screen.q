...
script decompress_loading
	change loading_screen_tips = [
		...
		'\n\n\n<YOU ARE ONLY HUMAN>\n\nor are you?'
		//'Clone Hero Ruined a Whole Generation of Players' // lol // but indisputable
		//
		...
		'The scripting language of this game is currently being implemented within itself. Yes. (press grave key!)'
